...
import com.sinosoft.frame.Constants;
...
public class BaseFormController implements ServletContextAware {
     ...
     * 日志管理
     **/
    private static SystemLogManager sysLogMgr = null;
    
    @Autowired
    public  void setSysLogMgr(SystemLogManager sysLogMgr) {
		BaseFormController.sysLogMgr = sysLogMgr;
	}
    
    @Autowired
    SystemLogDao dao;
    
    public SystemLogManager getSysLogMgr(){
    	return sysLogMgr;
    }
    
    public SystemLogDao getSysLogDao(){
    	return dao;
    }
    /**
     * 日志管理
    ...
    public List getlistUser() {
		List userl = (List) servletContext
				.getAttribute("sessionuserlist");
		return userl;
	}
}
