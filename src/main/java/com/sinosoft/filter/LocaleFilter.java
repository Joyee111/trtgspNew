...
import com.sinosoft.frame.webapp.filter.LocaleRequestWrapper;
    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (session != null) {
            if (preferredLocale == null) {
                ...
                request.getSession().setAttribute("lang", preferredLocale);
...
//            request.getSession().setAttribute("lang", lcl);
//        }
    }
}
