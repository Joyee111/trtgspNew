...
<html>
<head>
<title>查看已审核首营品种</title>
</head>
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">品种管理&nbsp;>&nbsp;首营品种&nbsp;>&nbsp;查看已审核首营品种</font>
	<form action="" name="audited_syybysh" id="audited_syybysh" method="post" enctype="multipart/form-data">
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="xx_table">
          <tr>
            ...
            <td><input name="commonName" value="${firstVariety.commonName}" type="text" class="text1"  size="40" readonly="readonly"/></td>
            <th width="150">剂    型<span class="required">*</span>：</th>
            <td><input name="dosageForms" value="${firstVariety.dosageForms.formName}"  type="text" class="text1"  size="40" maxlength="20" readonly="readonly"/></td>
          </tr>
          <tr>
            ...
            <td><input name="licenseNumber" value="${firstVariety.licenseNumber}" type="text" class="text1"  size="40" readonly="readonly"/></td>
          </tr>
          <tr>
            <th>生产企业<span class="required">*</span>：</th>
            <td><input name="produceNo" value="${firstVariety.produceNo.customerName}" type="text" class="text1" size="40" readonly="readonly"/></td>
          ...
          <th>药品规格<span class="required">*</span>：</th>
            ...
            <td><input name="specifications" value="${firstVariety.specifications}" type="text" class="text1"  size="40" readonly="readonly"/></td>
          </tr>
            <tr>
            <th>单位<span class="required">*</span>：</th>
            <td><input name="unit" type="text" value="${firstVariety.unit}" class="text1" size="40" readonly="readonly"/></td>
            <th>质量标准依据<span class="required">*</span>：</th>
            <td><input name="qualityStandardName" value="${firstVariety.qualityStandardName}" type="text"  size="40" class="text1"  readonly="readonly"/></td>
          </tr>
           <tr>
          ...
          <tr>
            ...
            <td><input name="validDate" value="${firstVariety.registeredTrademarks}" type="text" class="text1" size="40"  readonly="readonly"  maxlength="20" /></td>
          	<th>有效期（月）<span class="required">*</span>：</th>
            <td><input name="validDate" value="${firstVariety.validDate}" type="text" class="text1" size="40"  readonly="readonly"  maxlength="20" /></td>
          </tr>
          <tr>  
          ...
          <tr>
            ...
            <td colspan="3"><textarea name="function" cols="94" rows="4" class="easyui-validatebox  textarea"  data-options="required:false,validType:'checkChina'" readonly="readonly">${firstVariety.function}</textarea></td>
          </tr>
          <tr>
            <th valign="top">申请原因<span class="required">*</span>：</th>
            <td colspan="3"><textarea name="applicationReason" cols="94" rows="4" class="easyui-validatebox  textarea"  data-options="required:false,validType:'checkChina'" readonly="readonly">${firstVariety.applicationReason}</textarea></td>
          </tr>
          <tr>
            <th valign="top">审核内容<span class="required">*</span>：</th>
            <td colspan="3"><textarea name="auditContent" cols="94" rows="4" class="easyui-validatebox  textarea"  data-options="required:false,validType:'checkChina'" readonly="readonly">${firstVariety.auditContent}</textarea></td>
          </tr>
          <%--
          <tr>
            <th>厂商证照：</th>
          ...
          <tr>
            ...
            <%}else{ %>
            <td>
            <input type="text" name="packPath" value="未上传附件" class="text1" size="40"/>
            </td>
            <%} %>
            <th>标签、说明书：</th>
          ...
          <%-- 
          	...
          	<th>检验报告书</th>
            	...
            	<td>
           		<img src="../images/pdf.gif" />
            	<a href="../download.html?fileName=${firstVariety.checkoutReportpath}"><%="标签、说明书"+StringUtil.fileExtensions(variety.getCheckoutReportpath())%></a>
          ...
          <tr height="80">
            <td colspan="4" align="center" valign="bottom">
            	<input  type="hidden" name="id" id="" value="${firstVariety.id}">
            	<shiro:hasPermission name="FirstMedicine_audited_return">
            	 <input name="" type="button" class="btn_big" value="确认驳回" onclick="comfrin_sypz()"/>
            	 </shiro:hasPermission>
		...
		setCheckByName("departmentId","${firstVariety.departmentId}");
         function comfrin_sypz(){
		  $('#audited_syybysh').attr("action","confrimRejectQualityMidince.html");
		  var comfrim_sure = confirm("是否确认驳回！");
		  if(comfrim_sure){
		  		  $('#audited_syybysh').form('submit',{  
			...
			//  alert(data);
				...
				location.href="firstVariety.html?type=waitAudit";
			    }  
			});  
		  }else{
		  	return;
        ...
        var specialManagement="${firstVariety.specialManagement}";
        $(function(){
           add();
        })	
        function add(){
          $("#specialManagement option[value='"+specialManagement+"']").attr("selected","selected");
        }
        </script>
	</form>
</body>
