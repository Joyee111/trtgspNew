...
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">品种管理&nbsp;>&nbsp;首营品种&nbsp;>&nbsp;首营品种已驳回</font>
		 <div class="tab_biao">
			...
			<shiro:hasPermission name="FirstMedicine_reject">
				<a href="firstVariety.html?type=rejected" class="on"><span><font>已驳回</font>
				</span> </a>
			</shiro:hasPermission>
		</div>
    	 ...
    	 <div class="tab_con">
        	<div class="caozuo_box">
         	<form name="query_syqydlr" id="query_firstVariety" action=queryfirstVariety.html method="post">
                ...
                <input type="hidden" name="type" type="button" value="rejected" >
                
                <shiro:hasPermission name="FirstMedicine_reject_find">
            ...
            <form name="del_sypzdlr" action="delte_syqydql.html" id="del_sypzdlr" method="post" >
 			<display:table name="firstVarietyList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="firstVariety" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="FirstMedicine_reject_look">
				<display:column titleKey="操作" autolink="true" media="html"  class="border_rnone">
				<img src="../images/look.gif"/><a href="viewRejectedFirstVariety.html?id=${firstVariety.id}">查看</a>
				</display:column>
				</shiro:hasPermission>
