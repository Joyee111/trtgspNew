...
<body>
		<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;采购人员/提货人员&nbsp;>&nbsp;采购人员/提货人员录入</font>
		 <div class="tab_biao">
		 	<shiro:hasPermission name="BuyerQualify_recorded" >
			<a href="procurementStaffList.html?type=0" class="on" ><span><font>录入</font>
			</span>
			</a>
			</shiro:hasPermission>
    	 ...
    	 <div class="tab_con">
        	...
        	<form name="query_sxrydlr" id="query_sxrydlr" action="queryProcurementStaffList.html" method="post">
               	...
               	<shiro:hasPermission name="BuyerQualify_recorded_find">
                <input name="" type="submit" class="btn_big" value="查询"/>
                </shiro:hasPermission>
           </form>
            </div>
            <form name="del_xsry" action="delteProcurementStaff.html" id="del_xsry" method="post" >
 			<display:table name="procurementStaffList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="procurement" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="BuyerQualify_recorded_modify">
				<display:column titleKey="操作" autolink="true" media="html"  class="border_rnone">
				<img src="../images/edit.gif"/><a href="editProcurementStaff.html?id=${procurement.id}&type=0">编辑</a>
				</display:column>
				</shiro:hasPermission>
            ...
            <shiro:hasPermission name="BuyerQualify_recorded_add">
            <input name="" type="button" class="btn_big" value="新增" onclick="addprocurementsStaff()"/>
            </shiro:hasPermission>
            <c:choose>
			<c:when test="${deleteItemFlag eq 'true'}">
				  <shiro:hasPermission name="BuyerQualify_recorded_delete">
            <input name="" type="button" class="btn_big" value="删除" onclick="delprocurementsStaff()"/>
            </shiro:hasPermission>
			</c:when>
	...
	<script type="text/javascript">
	function addprocurementsStaff(){
		window.location.href="addProcurementStaff.html";
	}
	function delprocurementsStaff(){
