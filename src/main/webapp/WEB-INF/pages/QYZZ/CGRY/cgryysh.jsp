...
<body>
		<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;采购人员/提货人员&nbsp;>&nbsp;采购人员/提货人员已审核</font>
		 <div class="tab_biao">
			...
			<a href="procurementStaffList.html?type=2" class="on"><span><font>已审核</font>
			</span>
			</a>
			</shiro:hasPermission>
    	 ...
    	 <div class="tab_con">
        	...
        	<form name="query_sxrydlr" id="query_sxrydlr" action="queryProcurementStaffList.html" method="post">
               	...
               	<shiro:hasPermission name="BuyerQualify_audited _find">
 			...
 			<display:table name="procurementStaffList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="procurement" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="BuyerQualify_audited_look">
				<display:column titleKey="操作" autolink="true" media="html"  class="border_rnone">
				<img src="../images/look.gif"/><a href="editProcurementStaff.html?id=${procurement.id}&type=2">查看</a>
				</display:column>
				</shiro:hasPermission>
