...
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;购货单位&nbsp;>&nbsp;购货单位已驳回</font>
	<div class="tab_biao">
			...
			<shiro:hasPermission name="PurchaseUnit_reject">
				<a href="ghdwybh.html" class="on"><span><font>已驳回</font>
				</span>
				</a>
			</shiro:hasPermission>
        </div>
        <div class="tab_con">
        	...
        	<form name="query_ghdwybh" id="query_ghdwybh" action="query_ghdwybh.html" method="post">
                ...
                <shiro:hasPermission name="PurchaseUnit_reject_find">
                <input name="" type="submit" class="btn_big" value="查询"/>
                </shiro:hasPermission>
            </form>
            </div>
           <display:table name="purchaseUnitsRejectList" cellspacing="0" cellpadding="0" requestURI="" style="width:100%;" id="purchaseUnit" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="PurchaseUnit_reject_look">
				<display:column titleKey="操作" autolink="true" media="html" class="border_rnone">
				<img src="../images/look.gif"/><a href="view_ghdwybh.html?id=${purchaseUnit.id}">查看</a>
				</display:column>
				</shiro:hasPermission>
