...
<body>
	<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;供货单位销售人员&nbsp;>&nbsp;供货单位销售人员审核</font>
	<form action="auditSalesStaff.html" name="edit_xsrydsh" id="edit_xsrydsh" method="post" >
	 ...
	 <div id="dialog" title="申请驳回" class="easyui-dialog" style="width:800px;height:300px;padding:10px; margin-top: 20px;"  data-options="closed:true,modal:true,top:100">
        <form id="audit" name="" action="auditSalesStaff.html" method="post">
    	<table>
    	<tr>
            <th valign="top">驳回原因：</th>
            <td colspan="3"><textarea name="reject_reason" cols="94" rows="4" class="easyui-validatebox  textarea"  data-options="required:true"></textarea></td>
		</tr>
		<tr>
			<td colspan="4" align="center" valign="bottom">
			<input type="hidden" id="save_type2" name="save_type" value="1"/>
			<input type="hidden" id="id2" name="p_id" value="${salesStaff.id}"/>
