...
<body>
		<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;供货单位销售人员&nbsp;>&nbsp;供货单位销售人员录入</font>
		 <div class="tab_biao">
			<shiro:hasPermission name="SalesQualify_recorded">
				<a href="salesStaff.html?type=0" class="on"><span><font>录入</font>
				</span> </a>
			</shiro:hasPermission>
			<shiro:hasPermission name="SalesQualify_auditing">
				<a href="salesStaff.html?type=1"><span><font>审核</font>
				</span> </a>
			</shiro:hasPermission>
    	 ...
    	 <div class="tab_con">
        	...
        	<form name="query_sxrydlr" id="query_sxrydlr" action="querySalesStaff.html" method="post">
               	...
               	<shiro:hasPermission name="SalesQualify_recorded_find">
                <input name="" type="submit" class="btn_big" value="查询"/>
                </shiro:hasPermission>
           </form>
            </div>
            <form name="del_xsry" action="delteSalesStaff.html" id="del_xsry" method="post" >
 			<display:table name="salesStaffList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="sale" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<display:column property="telephone" escapeXml="true" sortable="false" titleKey="联系电话"/>
				 <shiro:hasPermission name="SalesQualify_recorded_modify">
				<display:column titleKey="操作" autolink="true" media="html"  class="border_rnone">
				<img src="../images/edit.gif"/><a href="editSalesStaff.html?id=${sale.id}&type=0">编辑</a>
				</display:column>
				</shiro:hasPermission>
            ...
            <shiro:hasPermission name="SalesQualify_recorded_add">
            <input name="" type="button" class="btn_big" value="新增" onclick="addSalesStaff()"/>
           </shiro:hasPermission>
           <c:choose>
			<c:when test="${deleteItemFlag eq 'true'}">
				 <shiro:hasPermission name="SalesQualify_recorded_delete">
            <input name="" type="button" class="btn_big" value="删除" onclick="delSalesStaff()"/>
            </shiro:hasPermission>
			</c:when>
	...
	function addSalesStaff(){
		window.location.href="addSalesStaff.html";
	}
	function delSalesStaff(){
