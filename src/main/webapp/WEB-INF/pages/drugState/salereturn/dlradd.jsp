...
<script type="text/javascript">
   ...
   <font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">药品状态管理&nbsp;>&nbsp;售出退货管理&nbsp;>&nbsp;售出退货新增</font>
...
<table border="0" cellspacing="0" cellpadding="0" class="xx_table">
	...
	<input type="text" class="easyui-combobox  text1" data-options="required:true" name="" id="commonnameboxs" size="40"/>
			<input type="hidden" id="qualifiedPurchaseUnitsIdValue" name="qualifiedPurchaseUnitsId" />
	</td>
	...
	<th width="150">数量：</th>
	<td class="left" style="width:350px;">
		<input type="text" name="quantity" id="quantity" class="text1" size="40"/>
	</td>
	<th width="150">生产批号：</th>
	<td class="left" style="width:350px;">
		<input type="text" name="batchNumber" id="batchNumber" class="text1" size="40"/>
	</td>	
	</tr>
	<tr>
