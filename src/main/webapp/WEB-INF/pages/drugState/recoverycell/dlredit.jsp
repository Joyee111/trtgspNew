...
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">药品状态管理&nbsp;>&nbsp;恢复销售管理&nbsp;>&nbsp;恢复销售修改</font>
...
<table border="0" cellspacing="0" cellpadding="0" class="xx_table">
	...
	<th width="150">存放地点<span class="required">*</span>：</th>
		<td class="left" style="width:350px;">
			<input type="text" name="location" id="location" value="${mc.location}" data-options="required:true" class="easyui-validatebox text1" readonly="readonly" size="40"/>
	</td>
	</tr>
	<tr>
	<th width="150">生产批号<span class="required">*</span>：</th>
	<td class="left" style="width:350px;">
		<input id="batchProduction" size="40" class="easyui-combobox" data-options="
		required:true,
		valueField:'id',
		textField:'text',
		value:'${mc.batchProduction}',
		url :'${ctx}/drugState/recoverycell/findypboxbyid.html?id='+${mc.qualifiedMedicineId},
		onSelect: function(rec){
	...
	<td class="left" style="width:350px;">
		<input type="text" name="quantity" id=quantity onchange="changequ(this)" value="${mc.quantity}" data-options="required:true,validType:'checkInt'" class="easyui-validatebox text1" maxlength="20" size="40"/>
