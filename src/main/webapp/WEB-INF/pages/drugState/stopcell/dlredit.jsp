...
<script type="text/javascript">
   ...
   <font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">药品状态管理&nbsp;>&nbsp;停售管理&nbsp;>&nbsp;停售录入修改</font>
...
<input type="hidden" name="tempStopStatus" id="tempStopStatus" value = "${mc.tempStopStatus}" />
...
<table border="0" cellspacing="0" cellpadding="0" class="xx_table">
	...
	<td style="width:400px;">
		<input type="text" class="easyui-combobox  text1" data-options="required:true,
     	 	valueField: 'id',
      		textField: 'text',
	...
	<td class="left" style="width:350px;">
		<input type="text" name="shengchanchangjia" id="shengchanchangjia" value="${qm.produceno.customerName}" class="text1" size="40"/>
	</td>	
	...
	<td class="left" style="width:350px;">
		<c:choose>
			<c:when test="${dateDisableFlag == 'true'}">
				<input type="text" class="easyui-datebox text1" data-options="required:true,value:getCurrentDate()" value="${mc.checkDate}" name="checkDate" id="checkDate"  size="40"/>
			</c:when>
			<c:when test="${dateDisableFlag == 'false'}">
				<input type="text" class="easyui-datebox text1" data-options="required:true,value:getCurrentDate(),disabled:true" value="${mc.checkDate}" name="checkDate" id="checkDate"  size="40"/>
			</c:when>
		</c:choose>
	...
	<th width="150">存放地点<span class="required">*</span>：</th>
		<td class="left" style="width:350px;">
			<input type="text" name="location" id="location" value="${mc.location}" class="text1" size="40" readonly="readonly"/>
	</td>
	</tr>
	<tr>
	<th width="150">生产批号<span class="required">*</span>：</th>
	<td class="left" style="width:350px;">
	<!--<input id="batchProduction" size="40" class="easyui-combobox" data-options="required:true,valueField:'id',textField:'text',
		value:'${mc.batchProduction}',
		...
		" />-->
		<input type="text" name="batchProduction" id="batchProduction"  data-options="required:true" class="easyui-validatebox text1" size="40" value="${mc.batchProduction}"/> 
		<!-- <input type="hidden" name="batchProduction" id="batchProductionValue" value="${mc.batchProduction}"/>-->
		<!--  <input type="text" name="batchProduction" id="batchProduction" value="${mc.batchProduction}"  data-options="required:true" class="easyui-validatebox text1" size="40"/>-->
	</td>
	<th width="150">数量<span class="required">*</span>：</th>
	<td class="left" style="width:350px;">
		<!-- <input type="text" name="quantity" onchange="changequ(this)" id="quantity" value="${mc.quantity}" data-options="required:true" class="easyui-validatebox text1" size="40"/>-->
		<input type="text" name="quantity" id="quantity" value="${mc.quantity}" data-options="required:true" class="easyui-validatebox text1" size="40"/>
	...
	<th valign="top">停售原因：</th>
	 <td colspan="3">
		<textarea type="" name="checkSituation" id="checkSituation" cols="94" rows="4" data-options="required:true" class="easyui-validatebox textarea" >${mc.checkSituation}</textarea>
	</td>
	</tr>
	
	<tr>
		<th>
			<input type="checkbox" id="checkTempStopStatus" onchange="if(this.checked==true){this.value='1'}else{this.value='0'};$('#tempStopStatus').val(this.value);" value="${mc.tempStopStatus}">
		</th>
		 <td colspan="3">
	       &nbsp;暂时停售
		</td>
