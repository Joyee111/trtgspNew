...
<div>
   <font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">综合查询统计分析&nbsp;>&nbsp;样品票记录</font>
	<div class="tab_con">
		<div class="caozuo_box">
			<form name="query" id="query" action="query.html" method="post">
	          ...
	          <input type="hidden" id="tuihuodanwei" name="tuihuodanwei" value="${tuihuodanwei}"/>
				...
				销售时间：<input type="text" class="easyui-datebox text1" name="startDate" id="startDate" data-options="validType:'date'"/>&nbsp;--&nbsp;<input type="text" class="easyui-datebox text1" name="endDate" id="endDate" data-options="validType:'date'"/>
				<label>经营公司:</label>
