...
*/		var lmcount = 0;
		...
		lm[26]=new Array("呼和浩特市","内蒙古自治区");
		
		lm[27]=new Array("包头市","内蒙古自治区");
		
		lm[28]=new Array("乌海市","内蒙古自治区");
		
		lm[29]=new Array("赤峰市","内蒙古自治区");
		
		lm[30]=new Array("通辽市","内蒙古自治区");
		
		lm[31]=new Array("鄂尔多斯市","内蒙古自治区");
		
		lm[32]=new Array("呼伦贝尔市","内蒙古自治区");
		
		lm[33]=new Array("巴彦淖尔市","内蒙古自治区");
		
		lm[34]=new Array("乌兰察布市","内蒙古自治区");
		
		lm[35]=new Array("兴安盟","内蒙古自治区");
		
		lm[36]=new Array("锡林郭勒盟","内蒙古自治区");
		
		lm[37]=new Array("阿拉善盟","内蒙古自治区");
		...
		lm[220]=new Array("南宁市","广西壮族自治区");
		
		lm[221]=new Array("柳州市","广西壮族自治区");
		
		lm[222]=new Array("桂林市","广西壮族自治区");
		
		lm[223]=new Array("梧州市","广西壮族自治区");
		
		lm[224]=new Array("北海市","广西壮族自治区");
		
		lm[225]=new Array("防城港市","广西壮族自治区");
		
		lm[226]=new Array("钦州市","广西壮族自治区");
		
		lm[227]=new Array("贵港市","广西壮族自治区");
		
		lm[228]=new Array("玉林市","广西壮族自治区");
		
		lm[229]=new Array("百色市","广西壮族自治区");
		
		lm[230]=new Array("贺州市","广西壮族自治区");
		
		lm[231]=new Array("河池市","广西壮族自治区");
		
		lm[232]=new Array("来宾市","广西壮族自治区");
		
		lm[233]=new Array("崇左市","广西壮族自治区");
		...
		lm[325]=new Array("银川市","宁夏回族自治区");
		
		lm[326]=new Array("石嘴山市","宁夏回族自治区");
		
		lm[327]=new Array("吴忠市","宁夏回族自治区");
		
		lm[328]=new Array("固原市","宁夏回族自治区");
		
		lm[329]=new Array("中卫市","宁夏回族自治区");
		
		lm[330]=new Array("乌鲁木齐市","新疆维吾尔自治区");
		
		lm[331]=new Array("克拉玛依市","新疆维吾尔自治区");
		
		lm[332]=new Array("吐鲁番地区","新疆维吾尔自治区");
		
		lm[333]=new Array("哈密地区","新疆维吾尔自治区");
		
		lm[334]=new Array("昌吉自治州","新疆维吾尔自治区");
		
		lm[335]=new Array("博尔塔拉州","新疆维吾尔自治区");
		
		lm[336]=new Array("巴音郭楞州","新疆维吾尔自治区");
		
		lm[337]=new Array("阿克苏地区","新疆维吾尔自治区");
		
		lm[338]=new Array("克孜勒苏州","新疆维吾尔自治区");
		
		lm[339]=new Array("喀什地区","新疆维吾尔自治区");
		
		lm[340]=new Array("和田地区","新疆维吾尔自治区");
		
		lm[341]=new Array("伊犁自治州","新疆维吾尔自治区");
		
		lm[342]=new Array("塔城地区","新疆维吾尔自治区");
		
		lm[343]=new Array("阿勒泰地区","新疆维吾尔自治区");
		
		lm[344]=new Array("新疆省辖单位","新疆维吾尔自治区");
