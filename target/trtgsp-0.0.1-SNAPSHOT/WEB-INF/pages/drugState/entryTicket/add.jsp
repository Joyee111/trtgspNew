...
<body>
	<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">药品状态管理&nbsp;>&nbsp;入库单制单&nbsp;>&nbsp;入库单新增</font>
          ...
          <th width="150">生产批号<span class="required">*</span>：</th>
            <td><input type="text" class="easyui-combobox text1" 
            	data-options="
            		...
            		valueField: 'id',
            		textField: 'text',
            		url:'${ctx}/trtgsp/drugState/EntryTicket/findysd.html',
            		onSelect: function(rec){
      			             find(rec.id,rec.text);
      			            
      		      }
				" 
            	size="40"  name="" id="scph" value=""/>
            	<input type="hidden"  name="scph" value="" id="batchno"/>
            ...
            <td><input name="yxqz" type="text" class="easyui-datebox text1" data-options="required:false,validType:'date'" disabled="disabled"size="40" id="yxqz" value="${entryTicket.yxqz}"readonly="readonly"/></td>
          </tr>
          <tr>
	...
	<script type="text/javascript">
		...
		function find(id,batch){
					 ...
					 $("#ysy2").val("");
					 $("#jygs").val("");
			$.post("${ctx}/trtgsp/drugState/EntryTicket/findET.html",{
        ...
        onChange:function (newValue, oldValue){  
            if(newValue !=null && newValue!=""){  
                var urlStr ="${ctx}/trtgsp/drugState/EntryTicket/findysd.html?batch=" + encodeURIComponent(newValue);  
