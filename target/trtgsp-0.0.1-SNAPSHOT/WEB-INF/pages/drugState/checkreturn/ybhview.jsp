...
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">药品状态管理&nbsp;>&nbsp;退货验收管理&nbsp;>&nbsp;查看已驳回退货验收</font>
...
<body>
	...
	<tr>
	<th width="150">检查结论：</th>
	<td class="left" style="width:350px;">
		<input type="text" name="checkConclusion" readonly="readonly" id="checkConclusion" value="${mc.checkConclusion}" class="text1" size="40"/>
	</td>
	</tr>
	<tr>
...
<table id="condition_table" class="table_yh"  border="0" cellpadding="0" cellspacing="1" width="100%" align="center">
	<thead class='pn-lthead'>
	 <tr>
	 	<th style="width: 80px;">通用名称</th><th>剂型</th><th>规格</th> <th>数量</th><th>合格数量</th><th>不合格数量</th><th>生产批号</th><th>批准文号</th><th>生产企业</th><th>有效期至</th>
	  </tr>
	  </thead>
