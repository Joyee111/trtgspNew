...
<html>
	...
	<div id="print_div" >
		...
		<%
			List<QualityAcceptanceReportDto> list = (List<QualityAcceptanceReportDto>)request.getAttribute("reportDtos");
			String batchNumber = request.getParameter("batchNumber");
			String filePath = request.getSession().getServletContext()
					.getRealPath("/");
			String jasperTempFile = filePath + "templet\\QualityAcceptanceReport.jasper";
