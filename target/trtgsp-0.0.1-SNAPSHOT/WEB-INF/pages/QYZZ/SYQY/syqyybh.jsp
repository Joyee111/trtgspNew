...
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;首营企业&nbsp;>&nbsp;首营企业已驳回</font>
		<div class="tab_biao">
		...
		<shiro:hasPermission name="FirstEnterprise_reject">
			<a href="syqyybh.html" class="on" ><span><font>已驳回</font>
			</span>
			</a>
		</shiro:hasPermission>
		</div>
		...
		<div class="tab_con">
			<div class="caozuo_box">
				<form name="query_syqyysh" id="query_syqyysh"
					action="query_syqyybh.html" method="post">
					企业/法人名称
					...
					<shiro:hasPermission name="FirstEnterprise_reject_find">
					<input name="" type="submit" class="btn_big" value="查询" />
					</shiro:hasPermission>
				</form>
			</div>
		<form name="reject_syqyybh" action="" id="reject_syqyybh" method="post" >
 			<display:table name="firstEnterRejectList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="rejectEnter" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
 				<display:column title="<input type='checkbox' id='checkall' name='checkall' value='${id }' onclick='checkAll(\"delete_id\")' />全选" media="html"><input type="checkbox" name="delete_id" value="${rejectEnter.id}" ></display:column>
				...
				<shiro:hasPermission name="FirstEnterprise_reject_look">
				<display:column titleKey="操作" autolink="true" media="html" class="border_rnone">
				 <img src="../images/look.gif"/><a href="view_syqyybh.html?id=${rejectEnter.id }">查看</a>
				</display:column>
				</shiro:hasPermission>
