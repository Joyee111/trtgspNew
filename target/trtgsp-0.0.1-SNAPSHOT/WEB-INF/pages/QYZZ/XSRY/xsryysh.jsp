		...
		<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;供货单位销售人员&nbsp;>&nbsp;供货单位销售人员已审核</font>
		 <div class="tab_biao">
			...
			<shiro:hasPermission name="SalesQualify_audited">
				<a href="salesStaff.html?type=2" class="on"><span><font>已审核</font> </span>
				</a>
			</shiro:hasPermission>
    	 ...
    	 <div class="tab_con">
        	...
        	<form name="query_sxrydlr" id="query_sxrydlr" action="querySalesStaff.html" method="post">
               ...
               <shiro:hasPermission name="SalesQualify_audited_find">		
 			...
 			<display:table name="salesStaffList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="sale" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="SalesQualify_audited_look">
				<display:column titleKey="操作" autolink="true" media="html"  class="border_rnone">
				<img src="../images/look.gif"/><a href="editSalesStaff.html?id=${sale.id}&type=2">查看</a>
				</display:column>
				</shiro:hasPermission>
