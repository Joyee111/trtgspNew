...
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">品种管理&nbsp;>&nbsp;首营品种&nbsp;>&nbsp;首营品种审核</font>
		 <div class="tab_biao">
			...
			<shiro:hasPermission name="FirstMedicine_auditing">
				<a href="firstVariety.html?type=waitAudit"  class="on"><span><font>审核</font>
				</span> </a>
			</shiro:hasPermission>
    	 ...
    	 <div class="tab_con">
       	...
       	<form name="query_syqydlr" id="query_firstVariety" action=queryfirstVariety.html method="post">
                ...
                <shiro:hasPermission name="FirstMedicine_auditing_find">
                <input name="" type="submit" class="btn_big" value="查询"/>
                </shiro:hasPermission>
           </form>
            </div>
            <form name="del_sypzdsh" action="batchAuditFirstVariety.html" id="del_sypzdsh" method="post" >
 			<display:table name="firstVarietyList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="firstVariety" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="FirstMedicine_auditing_look">
				<display:column titleKey="操作" autolink="true" media="html"  class="border_rnone">
				<img src="../images/look.gif"/><a href="viewWaitAuditFirstVariety.html?id=${firstVariety.id}">查看</a>
				</display:column>
				</shiro:hasPermission>
	...
	function batchFirsrVariety(value){
		$("#save_type").val(value)
		var from =document.getElementById("del_sypzdsh");
