...
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">品种管理&nbsp;>&nbsp;首营品种&nbsp;>&nbsp;首营品种录入</font>
		 <div class="tab_biao">
			<shiro:hasPermission name="PurchaseUnit_recorded">
				<a href="firstVariety.html?type=input" class="on"><span><font>录入</font>
				</span> </a>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="FirstMedicine_audited">
				<a href="firstVariety.html?type=audited" ><span><font>已审核</font>
				</span> </a>
			</shiro:hasPermission>
    	 ...
    	 <div class="tab_con">
        	...
        	<form name="query_syqydlr" id="query_firstVariety" action=queryfirstVariety.html method="post">
                ...
                <input type="hidden" name="type" type="button" value="input" >
                <shiro:hasPermission name="FirstMedicine_recorded_find">
                <input name="" type="submit" class="btn_big" value="查询"/>
                </shiro:hasPermission>
           </form>
            </div>
            <form name="del_sypzdlr" action="deleteFirstVariety.html" id="del_sypzdlr" method="post" >
 			<display:table name="firstVarietyList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="firstVariety" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="FirstMedicine_recorded_modify">
				<display:column titleKey="操作" autolink="true" media="html"  class="border_rnone">
				<img src="../images/edit.gif"/><a href="viewFirstVariety.html?id=${firstVariety.id}">编辑</a>
				</display:column>
				</shiro:hasPermission>
            ...
            <input name="" type="button" class="btn_big" value="新增" onclick="addFirsrVariety()"/>
            </shiro:hasPermission>
            <c:choose>
			<c:when test="${deleteItemFlag eq 'true'}">
				 <shiro:hasPermission name="FirstMedicine_recorded_delete">
            <input name="" type="button" class="btn_big" value="删除" onclick="delFirsrVariety()"/>
            </shiro:hasPermission>
			</c:when>
