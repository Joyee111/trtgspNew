...
<html>
	...
	<div id="print_div" >
		<input type="button" id="print_button" class="btn_big" value="打印" onclick="print_area()"   style="float: right;margin-right: 200px;">
		<div id="print_area">
		 
		<%
			List<EntryTicket> list = (List<EntryTicket>)request.getAttribute("list");
