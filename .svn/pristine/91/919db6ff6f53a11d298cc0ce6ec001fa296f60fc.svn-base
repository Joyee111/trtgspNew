...
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;合格供货单位&nbsp;>&nbsp;合格供应商修改记录</font>
 			<display:table name="archivesList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="archives" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<display:column property="modifierId.realname" escapeXml="true" sortable="false" titleKey="变更人" />
				<display:column property="reason" escapeXml="true" sortable="false" titleKey="变更原因" />
				<display:column property="modifiedTime" escapeXml="true" sortable="false" titleKey="变更时间" decorator="com.sinosoft.util.FormatDateColumnDecorator"/>
            ...
            <script type="text/javascript">
            	function return_back(){
    				window.location.href="hggys.html"
    			}	
            </script>
