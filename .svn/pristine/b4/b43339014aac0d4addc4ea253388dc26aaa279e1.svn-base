...
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;&gt;&nbsp;购货单位&nbsp;&gt;&nbsp;购货单位已审核</font>
 	<div class="tab_biao">
			...
			<shiro:hasPermission name="PurchaseUnit_audited">
				<a href="ghdwysh.html" class="on"><span><font>已审核</font>
				</span>
				</a>
			</shiro:hasPermission>
        ...
        <div class="tab_con">
        	<div class="caozuo_box">
        		<form name="query_ghdwdsh" id="query_ghdwdsh" action="query_ghdwysh.html" method="post">
                ...
                <shiro:hasPermission name="PurchaseUnit_audited_find">
                <input name="" type="submit" class="btn_big" value="查询"/>
                </shiro:hasPermission>
                </form>
            </div>
           <display:table name="purchaseUnitsAuditedList" cellspacing="0" cellpadding="0" requestURI="" style="width:98%;" id="purchaseUnit" pagesize="${pagesize}" class="table" export="true" size="${resultSize}" partialList="true">
				...
				<shiro:hasPermission name="PurchaseUnit_audited_look">
				<display:column titleKey="操作" autolink="true" media="html" class="border_rnone">
				<img src="../images/look.gif"/><a href="view_ghdwysh.html?id=${purchaseUnit.id}">查看</a>
				</display:column>
				</shiro:hasPermission>
