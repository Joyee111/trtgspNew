...
<html>
<head>
<title>查看已驳回购货单位</title>
</head>
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;购货单位&nbsp;>&nbsp;查看已驳回购货单位</font>
<table width="70%" border="0" cellspacing="0" cellpadding="0" class="lch">
		...
		<form action="confrimReject_ghdwybh.html" name="confirmRejected_ghdwybh" id="confirmRejected_ghdwybh" method="post" enctype="multipart/form-data">
        ...
        <td><input name="customerNumber" type="text" class="text1" size="40" value="${purchaseUnit.customerNumber}" readonly="readonly"/></td>
          ...
          <tr>
            <th>质量负责人：</th>
            <td><input name="qualityPrincipal" type="text" value="${purchaseUnit.qualityPrincipal}" class="text1" size="40" readonly="readonly"/></td>
            <!-- 
            <th>十位码：</th>
          ...
          <th>开户日期：</th>
           ...
           <td><input name="taxReceiptPhone" value="${purchaseUtil.taxReceiptPhone }" type="text" class="text1" readonly="readonly" size="40"/></td>
          </tr>
          <tr>
         ...
         <!--  <tr>
            ...
            <td colspan="3"><textarea name="examineContent" cols="94" rows="4" class="textarea">${purchaseUnit.examineContent}</textarea></td>
          </tr>-->
          <tr>
            <th valign="top">驳回原因：</th>
            <td colspan="3"><textarea name="rejectCause" cols="94" rows="4" class="textarea" readonly="readonly">${purchaseUnit.rejectCause}</textarea></td>
          </tr>
            <tr>
            <th valign="top">备注：</th>
		...
		<%--
          <tr>
           ...
           <%} %>
            <th>营业执照到期时间：</th>
            <td>
            	<input type="text" name="businessLicenceDate" class="easyui-datebox" data-options="disabled:true"  value="${purchaseUnit.businessLicenceDate }"/>
            </td>
          </tr>
           <tr>
            <th>许可证：</th>
           ...
           <%} %>
            <th>许可证到期日期：</th>
            <td>
            	<input type="text" name="licenceDate" class="easyui-datebox" required="required" value="${purchaseUnit.licenceDate}"/>
            </td>
          </tr>
           <tr>
            <th>证明材料：</th>
           ...
           <%}else{ %>
             <td><input name="documentEvidencePath" type="file" class="easyui-validatebox text1" value="未上传附件" readonly="readonly" size="40" /></td>
           <%} %>
            <th>证明材料到期日期：</th>
            <td>
            	<input type="text" name="documentEvidenceDate" class="easyui-datebox" data-options="disabled:true" value="${purchaseUnit.documentEvidenceDate}"/>
            </td>
          </tr>--%>
                 <tr>
            <th>营业执照：</th>
	...
	$(function() {
		...
		function confirmRejected_ghdwybh(){
			var form = document.getElementById("confirmRejected_ghdwybh");
			form.action="confrimReject_ghdwybh.html";
			form.submit();
		}
	</script>
</body>
