...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	vCode = vCode + "<TABLE width = '100%' align='center' BORDER=1 BGCOLOR=\"" + this.gBGColor + "\">";
...
Calendar.prototype.show = function() {
	...
	this.wwrite("<TABLE WIDTH='100%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#e0e0e0' align='center'>");
...
//	this.wwrite("<select onchange='alert(this.options[selectedIndex].value);'>");
	this.wwrite("<select onchange=\"window.opener.Build(" +
		"'" + this.gReturnItem + "','"
		+ this.gMonth + "',this.options[selectedIndex].value, '"
		+ this.gFormat + "'" +
		");\">");
	var i;
	var s;
	for (i=1945;i<2050;i++){
                s = "";
		if (parseInt(this.gYear)==i)
		  s = "selected";
		this.wwrite("<option value='"+i+"'"+" "+s+">"+i+"</option>");
	}
	this.wwrite("</select>");
...
function show_calendar() {
	...
	*/
	...
	vWinCal = window.open("", "Calendar",
		"width=300,height=350,status=no,resizable=no,top=200,left=200");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
