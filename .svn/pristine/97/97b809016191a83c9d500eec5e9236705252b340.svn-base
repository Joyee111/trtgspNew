...
/**
 * @author lfl:
 * @version 创建时间：Jun 4, 2013 5:47:55 PM
 * 类说明
 */
public class FileOperate {
	private static Log log = LogFactory.getLog(FileOperate.class);
	/**
	 * 读取文本文件内容
	 * 
	 * @param filePathAndName 带有完整绝对路径的文件名
	 * @param encoding 文本文件打开的编码方式(一般为默认)
	 * @return 返回文本文件的内容
	 */
	...
	public static boolean delFile(String filePathAndName) {
		...
		try {
			...
			if (myDelFile.exists()) {
				...
				bea = false;
				log.debug(filePathAndName + " 删除文件操作出错");
			}
		} catch (Exception e) {
