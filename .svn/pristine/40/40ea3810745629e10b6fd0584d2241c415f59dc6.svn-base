...
@Entity
@Table(name="t_adverse_reaction_use_item")
@Cache(usage= CacheConcurrencyStrategy.READ_WRITE)
@Transactional
public class AdverseReactionUseItem implements Serializable {
	private Long id;
...
/*	private Long count;//备注 

	@	Formula("(select count(*) from TRTHR_USER a where a.id = 1)")
