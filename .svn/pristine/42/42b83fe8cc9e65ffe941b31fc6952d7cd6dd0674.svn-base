...
<body>
	...
	<form action="comfrimRejectSalesperson.html" name="edit_xsryybh" id="edit_xsryybh" method="post" >
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="xx_table">
         ...
         <!--  <tr>
           ...
           <tr>
            ...
            <td colspan="3"><textarea name="reject_cause" cols="94" rows="4" class="textarea" readonly="readonly">${salesStaff.reject_reason}</textarea></td>
          </tr>
          <tr>
            <th>法人委托书：</th>
	...
	<script type="text/javascript">
		...
		if(con){
		  $('#edit_xsryybh').form('submit',{  
				...
				location.href="salesStaff.html?type=3";
			    }  
			});  
		}else{
			return;
