...
<div class="tab_con">
	<div class="caozuo_box">
		<form action="${ctx}/drugState/checkreturn/dlrlist.html" method="post" >
...
<form action="" id="recordsss">
	...
	<display:table name="recordlist" cellspacing="0" cellpadding="0" requestURI=""  style="width:98%;" id="records" pagesize="${pageSize}" class="table" export="true" size="${resultSize}" partialList="true">
		...
		<shiro:hasPermission name="ReturnCheckAccept_recorded_modify">
		<img src="../../images/edit.gif"/><a href="${ctx}/drugState/checkreturn/dlredit.html?id=<c:out value="${records.id}"/>&thispage=${thispage}">
			<fmt:message key="button.update"/>
		</a>
		</shiro:hasPermission>
		<c:choose>
			<c:when test="${deleteItemFlag eq 'true'}">
				<shiro:hasPermission name="ReturnCheckAccept_recorded_delete">
...
<form id="delForm" method="post">
	...
	<shiro:hasPermission name="ReturnCheckAccept_recorded_add">
