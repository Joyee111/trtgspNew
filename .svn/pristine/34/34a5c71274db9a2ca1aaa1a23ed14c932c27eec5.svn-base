...
<html>
<head>
<title>查看审核首营品种</title>
</head>
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">品种管理&nbsp;>&nbsp;首营品种&nbsp;>&nbsp;查看审核首营品种</font>
	<form action="auditFirstVariety.html" name="audit_syybdsh" id="audit_syybdsh" method="post" enctype="multipart/form-data">
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="xx_table">
          <tr>
            ...
            <td><input name="dosageForm" value="${firstVariety.dosageForms.formName}" class="text1" type="text"  maxlength="20" readonly="readonly"/></td>
          </tr>
             <tr>
           ...
           <th>批准文号<span class="required">*</span>：</th>
            <td><input name="licenseNumber" value="${firstVariety.licenseNumber}" class="text1" type="text"  size="40" readonly="readonly"/></td>
          </tr>
          <tr>
            <th>生产企业<span class="required">*</span>：</th>
            <td><input name="produce_no" value="${firstVariety.produceNo.customerName}" class="text1" type="text" size="40" readonly="readonly"/></td>
           ...
           <!--  <th>包装规格<span class="required">*</span>：</th>
            <td><input name="specifications" value="${firstVariety.specifications}"  class="text1"type="text"  size="40" readonly="readonly"/></td>
             -->
          </tr>
          ...
          <tr>
            ...
            <td><input name="specifications" value="${firstVariety.specifications}" type="text" class="text1" readonly="readonly" size="40"/></td>
          </tr>
          <tr>
            ...
            <td><input name="qualityStandardName" value="${firstVariety.qualityStandardName}" class="text1" type="text"  size="40"  readonly="readonly"/></td>
          </tr>
           <tr>
           ...
           <tr>
            ...
            <td><input name="registeredTrademarks" value="${firstVariety.registeredTrademarks}" type="text"  class="text1" maxlength="20" data-options="disabled:true"/></td>
            <th>药品有效期<span class="required">*</span>：</th>
            <td><input name="validDate" value="${firstVariety.validDate}" type="text"  class="text1" maxlength="20" data-options="disabled:true"/></td>
          </tr>
          <tr>  
          ...
          <tr>
            ...
            <td colspan="3"><textarea name="function" class="textarea" cols="94" rows="4" readonly="readonly">${firstVariety.function}</textarea></td>
          </tr>
          <tr>
            <th valign="top">申请原因<span class="required">*</span>：</th>
            <td colspan="3"><textarea name="applicationReason" class="textarea" cols="94" rows="4"  readonly="readonly">${firstVariety.applicationReason}</textarea></td>
          </tr>
          <tr>
            <th valign="top">审核内容<span class="required">*</span>：</th>
            <td colspan="3"><textarea name="auditContent" class="textarea" cols="94" rows="4" >${firstVariety.auditContent}</textarea></td>
          </tr>
         <%-- 
          <tr>
            <th>厂商证照：</th>
          ...
          <tr height="80">
            <td colspan="4" align="center" valign="bottom">
                ...
                <input name="" type="button" class="btn_big" value="批准" onclick="audit_syqy(0)"/>
         ...
         <div id="dialog" title="申请驳回" class="easyui-dialog" style="width:800px;height:300px;padding:10px;margin-top:20px;"  data-options=" closed: true,modal:false,top:500">
         <form id="audit_2" action="auditFirstVariety.html" method="post">
    	<table>
    	<tr>
            <th valign="top">驳回原因：</th>
            <td colspan="3"><textarea name="rejectReason" cols="94" rows="4" class="easyui-validatebox  textarea"  data-options="required:true,validType:'checkChina'"></textarea></td>
		</tr>
		<tr>
			<td colspan="4" align="center" valign="bottom">
			<input type="hidden" id="save_type2" name="save_type" value=""/>
            <input type="hidden" id="id2"  name="id" value="${firstVariety.id}">
           	<input type="button" class="btn_big" onclick="audit_sypz(1)" value="确定">
    ...
    setCheckByName("departmentId","${firstVariety.departmentId}");
		function audit_syqy(value){
		  $("#save_type").val(value);
		  $('#audit_syybdsh').form('submit',{  
