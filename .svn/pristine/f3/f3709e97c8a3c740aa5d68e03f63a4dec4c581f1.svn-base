...
<div id="syqy_tab" >
   <font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">药品状态管理&nbsp;>&nbsp;购进退出管理&nbsp;>&nbsp;购进退出已驳回</font>
  	<div class="tab_biao">
...
<div>
	...
	<form action="${ctx}/drugState/purreturn/ybhlist.html" method="post" >
