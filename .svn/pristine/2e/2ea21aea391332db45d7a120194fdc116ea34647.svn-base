...
public class QualityFilesDaoImpl extends GenericDaoHibernate<QualityFiles, Long> implements QualityFilesDao {

	public QualityFilesDaoImpl() {
		super(QualityFiles.class);
