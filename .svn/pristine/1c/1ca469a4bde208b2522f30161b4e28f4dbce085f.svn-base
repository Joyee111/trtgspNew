...
<html>
<head>
<title>采购人员/提货人员已审核</title>
</head>
<body>
	<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;采购人员/提货人员&nbsp;>&nbsp;采购人员/提货人员已审核</font>
	<form action="qualifiedProcurementToReject.html" name="edit_xsryysh" id="edit_xsryysh" method="post" >
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="xx_table">
          ...
          <tr height="80">
            <td colspan="4" align="center" valign="bottom">
           		 ...
           		 <shiro:hasPermission name="BuyerQualify_audited_return">
	...
	<script type="text/javascript">
		...
		if(con){
		  $('#edit_xsryysh').form('submit',{  
				...
				location.href="procurementStaffList.html?type=2";
			    }  
			});  
		}else{
			return;
