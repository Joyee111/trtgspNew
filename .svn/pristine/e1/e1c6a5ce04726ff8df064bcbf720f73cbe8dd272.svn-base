...
<%@page import="com.sinosoft.ireportDTO.QualityAcceptanceReportDto"%>
<%@page import="com.sinosoft.ireportDTO.StopSellingOrderDto"%>
...
<html>
	...
	<div id="print_div" >
		...
		<%
			List<StopSellingOrderDto> list = (List<StopSellingOrderDto>)request.getAttribute("reportDtos");
			String batchNumber = request.getParameter("batchNumber");
			String filePath = request.getSession().getServletContext()
					.getRealPath("/");
			String jasperTempFile = filePath + "templet\\StopSellingOrder.jasper";
