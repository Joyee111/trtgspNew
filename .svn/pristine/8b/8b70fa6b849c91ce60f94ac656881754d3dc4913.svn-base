...
<html>
	...
	<body>
		...
		<form name="del_syqydlr" action="delte_syqydql.html" id="del_syqydlr"
			method="post">
			<display:table name="supplierList" cellspacing="0"
		...
		<%-- 		<display:column value="<%=++index %>" titleKey="序号" escapeXml="true"
				...
				<display:column property="busiLiceExpiDate" escapeXml="true"
					sortable="false" titleKey="营业执照到期时间" />
				<display:column property="liceExpiDate" escapeXml="true"
