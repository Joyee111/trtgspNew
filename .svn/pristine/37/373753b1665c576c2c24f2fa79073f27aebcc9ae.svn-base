...
<html>
<head>
<title>查看已审核购货单位</title>
</head>
<body>
<font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">企业资质管理&nbsp;>&nbsp;购货单位&nbsp;>&nbsp;查看已审核购货单位</font>
        ...
        <tr>
         ...
         <tr>
          ...
          <tr>
            ...
            <td colspan="3"><textarea name="examineContent" cols="94" rows="4" class="textarea" readonly="readonly">${purchaseUnit.examineContent}</textarea></td>
          </tr>
            <tr>
            <th valign="top">备注：</th>
          ...
          <tr>
           ...
           <%} %>
            <th>许可证到期日期：</th>
            <td>
            	<input type="text" name="licenceDate" class="easyui-datebox" data-options="disabled:true" value="${purchaseUnit.licenceDate}"/>
            </td>
          </tr>
           <tr>
            <th>证明材料：</th>
           ...
           <%} %>
            <th>证明材料到期日期：</th>
            <td>
            	<input type="text" name="documentEvidenceDate" class="easyui-datebox text1" data-options="disabled:true"  value="${purchaseUnit.documentEvidenceDate}"/>
            </td>
          </tr>--%>
                 <tr>
            <th>营业执照：</th>
          ...
          <tr height="80">
            <td colspan="4" align="center" valign="bottom">
           		 <input type="hidden" id="autid_type" name="autid_type" value=""/>
           	 	<input type="hidden" id="id" name="id" value="${purchaseUnit.id}"/>
           	 	<shiro:hasPermission name="PurchaseUnit_audited_return">
           	 	<input name="" type="button" class="btn_big" value="回退" onclick="comfrin_hgghdw()"/>
           	 	</shiro:hasPermission>
	...
	$(function() {
       ...
       function comfrin_hgghdw(){
		  $('#update_ghdwdsh').attr("action","confrimRejectQualefiedPurchase.html");
		  var comfrim_sure = confirm("是否确认驳回！");
		  if(comfrim_sure){
		  		  $('#update_ghdwdsh').form('submit',{  
