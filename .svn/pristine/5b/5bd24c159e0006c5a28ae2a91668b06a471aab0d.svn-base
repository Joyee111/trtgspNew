...
<script type="text/javascript">
    ...
    function add(){
    	...
    	form.action="${ctx}/drugState/scrap/dlradd.html";
    	form.submit();
    }

</script>
   <font style="font-family:'宋体';font-weight:normal; font-size: 12;color:#8d3c01;padding: 10px;">药品状态管理&nbsp;>&nbsp;报废管理&nbsp;>&nbsp;报废录入</font>
	<div class="tab_biao">
...
<div class="tab_con">
	<div class="caozuo_box">
		<form action="${ctx}/drugState/scrap/dlrlist.html" method="post">
	...
	<display:table name="reslist" cellspacing="0" cellpadding="0" requestURI=""  style="width:98%;" id="records" pagesize="${pageSize}" class="table" export="true" size="${resultSize}" partialList="true">
		...
		<display:column property="batchno"  titleKey="批号" autolink="true" media="html" style="border-right:1px solid #feb808;"></display:column>
			...
			<display:column property="applyTime"  escapeXml="true" titleKey="申请时间" format="{0,date,dd-MM-yyyy}"></display:column>
               ...
               <img src="../../images/edit.gif"/><a href="${ctx}/drugState/scrap/dlredit.html?id=<c:out value="${records.id}"/>&thispage=${thispage}">
			<fmt:message key="编辑"/>
		</a>
...
<form id="delForm" method="post">
	...
	<div class="caozuo_box2">
		<shiro:hasPermission name="Scrap_recorded_add">
